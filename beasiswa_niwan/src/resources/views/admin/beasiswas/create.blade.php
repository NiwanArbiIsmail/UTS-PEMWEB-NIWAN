    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.beasiswas.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jurusan') ? 'is-invalid' : '' }}" type="text" name="jurusan" id="jurusan" value="{{ old('jurusan', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fakultas') ? 'is-invalid' : '' }}" type="text" name="fakultas" id="fakultas" value="{{ old('fakultas', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('indeks') ? 'is-invalid' : '' }}" type="text" name="indeks" id="indeks" value="{{ old('indeks', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('beasiswa') ? 'is-invalid' : '' }}" type="text" name="beasiswa" id="beasiswa" value="{{ old('beasiswa', '') }}" step="1">
